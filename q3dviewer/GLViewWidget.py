...
from .gl_utils import frustum  # Import frustum function


class GLViewWidget(QtWidgets.QOpenGLWidget):
    
    def __init__(self, parent=None, rotationMethod='euler'):
    ...
    def projectionMatrix(self, region=None):
        # see: https://www.scratchapixel.com/lessons/3d-basic-rendering/perspective-and-orthographic-projection-matrix/opengl-perspective-projection-matrix.html
    ...
    def viewMatrix(self):
        tr = QtGui.QMatrix4x4()
        tr.translate( 0.0, 0.0, -self._dist)
    ...
    def pan(self, dx, dy, dz, relative='global'):
        ...
        *relative*      String that determines the direction of dx,dy,dz. 
        ...
        if relative == 'global':
            ...
            xDist = dist * 2. * tan(0.5 * radians(self._fov))  ## approx. width of view at distance of center point
    ...
    def pixelSize(self, pos):
        ...
        if isinstance(pos, np.ndarray):
            ...
            dist = (pos-cam).length()
        xDist = dist * 2. * tan(0.5 * radians(self._fov))
    ...
    def wheelEvent(self, ev):
        ...
        if (ev.modifiers() & QtCore.Qt.KeyboardModifier.ControlModifier):
            self._fov *= 0.999**delta
        else:
            self._dist *= 0.999**delta
        self.update()
